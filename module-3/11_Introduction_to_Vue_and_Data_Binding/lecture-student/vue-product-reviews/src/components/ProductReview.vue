...
export default {
  ...
  computed: {
    averageStarRating() {
      // also this.reviews.reduce((runningSum, curReview) => runningSum + curReview.rating, 0);
      let totalStars = this.reviews.reduce((runningSum, currentReview) => {
        return runningSum + currentReview.rating;
      }, 0);
