...
public class ExceptionsLecture {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // didn't go into the catch because these are two different errors
        ...
        } catch (ArrayIndexOutOfBoundsException e) { // e for exception, it's like i for looping just standard not required
            // Flow of control resumes here after the Exception is thrown
            // replace Array~ with Exception will catch the error but is sloppy because that's for 10000 errors
        ...
        try {
            ...
            System.out.println(e.getMessage()); // calls from the method error e
        }
