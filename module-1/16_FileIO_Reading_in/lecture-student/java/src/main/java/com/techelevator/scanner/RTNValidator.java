...
public class RTNValidator {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        try (Scanner fileScanner = new Scanner(inputFile)) { // this replaces below code
...
//
//			// file will remain open if exception is thrown so there needs to be a finally included
//		}
//        catch (Exception e) {
//        	// do exception handling whatever within
//		}
//        finally {
...
//        }
	 ...
	 * @throws NumberFormatException when routingNumber contains non-numeric characters
	 */
